...
i = 1000000
n_guesses = guesses
calculatedGuesses = [[point[0] for point in weightedCentroids],[point[1] for point in weightedCentroids]]
...
#Results from runs: 
    #_100 rounds:
        #Best guesses mean: 10.589566641383724 (out of 100)
        #All guesses mean: 16.6324981467497 (out of 300)
    #_10000 times:
        #Best guesses mean: 11.11591646897805 (out of 10.000)
        #All guesses mean: 17.231219124261294 (out of 30.000)
    #_1000000 times:
